...
namespace PersonsApp.Migrations
{
    ...
    [Migration("20260408014829_AgreandoSeguridadeTAblas")]
    partial class AgreandoSeguridadeTAblas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonasApp.Entities.RoleEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PersonasApp.Entities.UserEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("PersonasApp.Entities.RoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PersonasApp.Entities.UserEntity", null)
                        .WithMany()
